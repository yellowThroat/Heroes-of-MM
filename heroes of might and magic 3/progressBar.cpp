...
HRESULT progressBar::init(int x, int y, int width, int height)
{
	...
	_progressBarTop = IMAGEMANAGER->addImage("frontBar", "image/hpBarTop.bmp", x, y, width, height, true, RGB(255, 0, 255));
	_progressBarBottom = IMAGEMANAGER->addImage("backBar", "image/hpBarBottom.bmp", x, y, width, height, true, RGB(255, 0, 255));
